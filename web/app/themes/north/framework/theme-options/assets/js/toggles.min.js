    ...
    $.fn.toggles = function (d) {
        ...
        return this.each(function () {
            ...
            c.on("toggle", function (a,
                ...
                var toggle_id = $(this).parent('.toggle-checkbox').next('input').attr('id');
                var toggle_dep = $(this).parent('.toggle-checkbox').next('input').data('dependency');
                
                if(c.hasClass("active")) {                	
                	$('.f_'+toggle_id).slideDown();
                	var bg_img = $(this).closest('.section').next('.section-upload').find('input').val();
                	if(bg_img) {
                		$('#theme-preview .'+toggle_dep).css('background-image','url('+bg_img+')');
                	}
                } else {
                	$('.f_'+toggle_id).slideUp();
                	$('#theme-preview .'+toggle_dep).css('background-image','none');
                }
                e.trigger("toggle", !d)
            });
